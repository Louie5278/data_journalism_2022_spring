...
**Answer**
Spelling errors as well as random uppercase letters as well as personal names instead of cities
```{r}
...
**Answer**
It changed most of the names to title case, it corrected the spellings of the cities and it added a new column named cleaned cities
```{r}
cleaned_md_loans %>%
...
**Answer**
Yes there are significant changes in this version.
```{r}
cleaned_md_loans <- md_loans %>%
