...
**Answer**
It's just a blank space because we havent entered any data yet
```{r}
maryland_ppp_top_counties %>%
  ggplot()
```
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer**
Now we see a bar chart with data and labels 
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
...
**Answer**
Now the bar chart is in descending order 
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
Now the axis labels are easier to see and the chart is horizontal
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
It is more readable because it has guidelines on the chart
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer**
There are bold titles, cpations and the fonts and styles have changed to be more appealing and readable
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**
now the x-axis has dates attached to it 
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Now the dates are at an angle that allows for better readability.
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
