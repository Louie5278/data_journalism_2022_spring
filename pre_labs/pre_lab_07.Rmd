...
**Answer**
This page is a industry classification overview and it lists the naics codes and their accompyning industry.
### Task 3: Load image
...
**Answer**
I see a html file with code that created the finished webpage. 
...
**Answer**
The output displayed are 2 lines of html code that seem to be calling in different values 
```{r}
# read in the html
...
**Answer**
I see 3 rows and columns of html code, type and values of the list.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
I see a html file pop up and the line highlighted shows that the table 2 is under the class "tableTitle"
### Task 9: Load image
**Task** Run the following code to display an image showing what you should see on the web page.
```{r, echo=FALSE}
...
**Answer**
We see multiple tables with a positions column and example value column.
```{r}
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
Now there are 6 rows and it is showing us the sizes and values of the tables from above.
...
**Answer**
When I do that it opens up the specifics of each dataset and gives more information. 
### Task 14: Load image
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer**
I see naics codes with the name of the industry next to it 
### Task 16: Load image
...
**Answer**
I see the dataset without the rest of the other data sets. It's isolated now 
```{r}
...
**Answer**
a list of naics codes and the industries that correspond with them 
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
I  see multiple tables of workforce statistics 
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer**
I see raw html that seems to call in the rows of data we're looking for. 
```{r}
...
**Answer**
I see more html code that is selecting the table with employment info  
```{r}
...
**Answer**
I see a data set that has broken down the employment data into multiple categories
```{r}
...
**Answer**
Now we just have one row of data, which is what we wanted. 
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
I see info about mining, quarrying, and oil and gas extraction 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
I see info about the construction sector 
...
**Answer** I see small changes in each code, just changing the name  of the sector
```{r}
...
**Answer** Nothing popped up under the codeblock but a new value set was created 
```{r}
...
**Answer** I see the same list was produced as before but the code to create it was shorter 
```{r}
...
**Answer**
"Error in sector_list : object 'sector_list' not found"
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** I see another ;ist of all of te sectors
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer**
I see a list of sectors and some of them have ranges and the names of the sectors in the description column
```{r}
...
**Answer**
It showed us how many values were in our dataset, 20.
```{r}
nrow(naics_industry)
```
...
**Answer**
Now it has printed each number from 1 to 20, the number of values we had in our dataset 
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
...
**Answer**
We got a data set that tells us the amount of employees, which was 536.9
```{r}
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer** Another list of naics codes and the names of the sectors 
```{r}
# Define url of page we want to scrape
...
**Answer**
Now the data set also has a column with the urls 
```{r}
...
**Answer**
Now the data set also includes a sector_xpath_id column
```{r}
...
**Answer**
Now we hace less rows in the data set
```{r}
...
**Answer**
Now we only have one row and it's only the data we desired 
```{r}
...
**Answer** several lines with each line and url pasted
```{r}
...
**Answer**
Now the data has turned into a proper data set and is much cleaner and there are 10x6 rows and columns
```{r}
...
**Answer**
Now there is only one row for each set 
```{r}
...
**Answer**
Now there are only 10 columns because we cleaned it.
```{r}
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer**
Now there are no commas in the numbers and it is being read as a number 
```{r}
...
**Answer**
Now everything is in one data set instead of 19 seperate ones 
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
I see data series for workforce stats for the mining sector 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**
This is the data for the agriculture sector's employment rate. 
### Task 39: Load image
**Task** Run the following code to display an image showing what you should see on the web page.
...
**Answer**
Now the agriculture data has been removed from the table
```{r}
