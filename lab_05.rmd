...
Martinsburg_data <- Berkeley_loans_clean %>% 
  filter(city=="Martinsburg")

Martinsburg_data_filter <- Martinsburg_data %>%  left_join 
(naics_code.csv, by= ("Martinsburg_data_filter")
...
**A3.**
Martinsburg received the most loans with a total of 1166
The industry title that had the most loans were restaurants.
```{r}
...
**A4.**
My two best hypothesis as to why this tite got the most loans is because there may be a lot of restaurants in the Martinsburg area. Another reason may be because covid hurt a lot of dine in restaurants businesses so they needed the money.
