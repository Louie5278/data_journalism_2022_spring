...
Nitro	140	
```{r}
wv_ppp_loans %>% filter(project_county_name=="KANAWHA") %>%  
...
A2:
The zip code 25301 is in Charleston and it  has more ppp loan totals than any other zip code yet there are no businesses in that zip code that got a singluar loan greater than Jackson Kelly. 5.13 million dollars was forgiven but they only got a loan of 5.05 million dollars. This error can probably be chalked up to a human error. 
