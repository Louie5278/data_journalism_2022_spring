...
**A4** [There is a larger population in Kanawha County and less in Wirt County]
...
**A5** [The Greenbriar Hotel received $8,912,202. They are a luxury resort and it retained the max 500 jobs]
...
**A7** [When analyzing this data the thing that jumps out at me is that the max loan was nearly $9 million while the min was $165. The average loan amount was $77,338 and the median was $20,832 which means the large companies that are getting hege loans like The luxury hotel are skewing the data.  ]
```{r}
# Write the code to produce your answer here
