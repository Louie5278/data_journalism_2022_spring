...
**Answer**
The data set has 13 columns and is filled with data from each MD county and their vaccination stats by date
```{r}
...
**Answer**
There is an  unknown value for one of the counties 
...
**Answer**
There is no data every 10 days and the numbers are lower for the most recent dates
```{r}
...
**Answer**
It shows that there was a spike of people getting vaccinated in April and May and those numbers decreased significantly as months went by 
```{r fig.width=9}
ggplot() +
...
**Answer**
This shows us the MD counties and the amount of cases over about 2 years in a line chart 
```{r}
...
**Task** Run the following code and describe what the resulting chart shows
**Answer**
This shows a chart with the same data but different intervals
```{r}
...
**Answer**
a geo graph with the MD counties showing which had the most covid cases as of 2022-04-20
```{r}
ggplot() +
